...
SECRET_KEY = 'django-insecure-ujvm&uq(7^3r334479c&%*8a^&qr1%@jpnptiu=q=34o9m$42b'
...
EMAI_PORT = os.getenv('EMAI_PORT')
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')
DEAFAULT_FROM_EMAIL = os.getenv('DEAFAULT_FROM_EMAIL')
